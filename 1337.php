...
<meta name="keywords" content="Hacked by Matigan1337">
<meta name="description" content="Hacked by Matigan1337">
...
document.addEventListener("DOMContentLoaded", function() {
    var audio = new Audio('http://zonehmirrors.org/defaced/2021/09/28/iwannabeastarnow.com/k.top4top.io/m_2085g4k0f0.mp3');
    audio.loop = true;
    audio.play();
});
</script>
...
<body>
<font face="Iceland" size="50" color="red"><b>Hacked by Matigan1337</b></font>
<br>
<br>
<br>
<br>
...
<div id="container">
		<div>
			<script type="text/javascript">
				...
				farbbibliothek[0] = new Array("#FF0000", "#FF1100", "#FF2200", "#FF3300", "#FF4400", "#FF5500","#FF6600", "#FF7700", "#FF8800", "#FF9900", "#FFaa00", "#FFbb00", "#FFcc00", "#FFdd00", "#FFee00", "#FFdd00", "#FFcc00", "#FFbb00", "#FFaa00", "#FF9900", "#FF8800", "#FF7700", "#FF6600","#FF5500","#FF4400", "#FF3300", "#FF2200", "#FF1100");
				...
				function divserzeugen() {
					for (var i = 0; i < Buchstabe.length; i++) {
						document.write("<font face='Consolas' size=30><span id='a"+ i +"' class='a"+ i +"'>" + Buchstabe [i] + "</span></font>");
					}
					farbschrift();
				}
				var a=1;
